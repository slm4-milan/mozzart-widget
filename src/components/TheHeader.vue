<template>
  <section :style="backgroundHeader" class="header-background row align-items-center m-0">
    <div class="d-flex header-content justify-content-between">
...
.odd-value {
  ...
  text-align: center;
  color: #FDB913;
  text-shadow: 0px 0px 11px rgba(253, 185, 19, 0.2);
  margin-left: 1px;
}
